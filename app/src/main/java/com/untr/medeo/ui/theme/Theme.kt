package com.untr.medeo.ui.theme
...
private val LightColorScheme = lightColorScheme(
    primary = MedeoDayPrimary,
    onPrimary = MedeoDaySurface,
    primaryContainer = MedeoDayPrimarySoft,
    onPrimaryContainer = MedeoDayPrimaryDark,
    secondary = MedeoDaySecondary,
    onSecondary = MedeoDaySurface,
    secondaryContainer = MedeoDaySecondarySoft,
    onSecondaryContainer = ColorCompat.daySecondaryDark,
    tertiary = MedeoDayTertiary,
    onTertiary = MedeoDaySurface,
    tertiaryContainer = MedeoDayTertiarySoft,
    onTertiaryContainer = ColorCompat.dayTertiaryDark,
    background = MedeoDayBackground,
    onBackground = MedeoDayText,
    surface = MedeoDaySurface,
    onSurface = MedeoDayText,
    surfaceVariant = MedeoDaySurfaceVariant,
    onSurfaceVariant = MedeoDayTextMuted,
    outline = MedeoDayOutline,
    outlineVariant = MedeoDayOutline,
    error = ColorCompat.error,
    errorContainer = MedeoDayTertiarySoft,
